                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                <Dialog.Title as="h3" className="text-lg border-b pb-2 leading-6 text-gray-900 ">
                                    Writing a review for order number <span className='text-blue-400'>{toReview._id}</span>
                                </Dialog.Title>
                                <form onSubmit={submitHandler}>
                                    <div className="grid text-sm py-2 items-center">
                                        ...
                                        <div className='col-span-1 grid gap-2 pt-2'>
                                            <b className='text-base'>Product image:</b>
                                        ...
                                        <div className='col-span-1'>
                                            <b className='text-base'>Product description:</b>
                                            <textarea required onChange={(e)=>setDescription(e.target.value)} rows={5} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write something about the product..."></textarea>
                                        </div>
                                        <br/>
                                    ...
                                    <div className='col-span-1 flex gap-2 justify-center border-t items-center py-2'>
