...
export default function DeleteComment({isDelete, setIsDelete, toDelete, setToDelete}) {
    ...
    const handleDelete = async () => {
        try {
            const res = await axios.delete(`${import.meta.env.DEV ? import.meta.env.VITE_DEVCONNECTIONSTRING : import.meta.env.VITE_CONNECTIONSTRING}/reviews/delete-review/${toDelete._id}`, { headers: { "Content-Type": "application/json" } })
            if (res.data) {
        ...
        <Transition appear show={isDelete} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    ...
                    >
                        <label className='font-bold text-lg'>Delete Comment</label>
                    ...
                    <div className="mt-2">
                        <p className="text-sm text-gray-600 text-center">
                            You are about to delete the comment of <b>{toDelete.owner}</b> that is posted on <b>{moment(toDelete.createdAt).format('MM-DD-YYYY')}</b>. 
                        <br/>
                        <br/>
                            This action is irreversible, please proceed with caution. This comment and images associated with it will be deleted <b>forever</b> and can not be recovered.
                        </p>
                    </div>
