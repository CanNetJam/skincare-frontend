...
export default function DeleteVideo({isDelete, setIsDelete, toDelete, setToDelete}) {
    ...
    const handleDelete = async () => {
        try {
            const res = await axios.delete(`${import.meta.env.DEV ? import.meta.env.VITE_DEVCONNECTIONSTRING : import.meta.env.VITE_CONNECTIONSTRING}/videos/delete-video/${toDelete._id}`, { headers: { "Content-Type": "application/json" } })
            if (res.data) {
        ...
        <Transition appear show={isDelete} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    ...
                    >
                        <label className='font-bold text-lg'>Delete Video</label>
