...
export default function AddProduct() {
    ...
    async function submitHandler(e) {
        ...
        const loadingNotif = async function myPromise() {
            ...
            const res = await axios.post(`${import.meta.env.DEV ? import.meta.env.VITE_DEVCONNECTIONSTRING : import.meta.env.VITE_CONNECTIONSTRING}/product/create-product`, data, { headers: { "Content-Type": "application/json" } })
