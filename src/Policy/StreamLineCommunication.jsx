...
import pdf from '../assets/Policy/Communication.pdf'

export default function StreamLineCommunication() {
    ...
    return (
        <div className='bg-blue-200 h-auto w-full text-base sm:text-lg sm:p-8 p-4'>
            ...
            <section className='my-2'>
                <h1 className='subHeading text-center sm:mb-6 mb-2'>Streaming Line Communication<br/>(IP-005)</h1>
