...
import pdf from '../assets/Policy/Dress Code.pdf'
    ...
    return (
        <div className='bg-blue-200 h-auto w-full text-base sm:text-lg sm:p-8 p-4'>
            ...
            <section className='my-2'>
                <h1 className='subHeading text-center sm:mb-6 mb-2'>Dress Code<br/>(IP-008)</h1>
            ...
            <section className='container bg-white mx-auto sm:p-10 p-2 grid gap-2 sm:rounded-[30px] rounded-[10px]'>
                ...
                <PolicyEmail userData={userData?.user} policytitle={["Dress Code (IP-008)"]}/>
            </section>
        </div>
    )
}
