...
export default function MoreInfo({packageData}) {
    return (
        <div className='w-full bg-gray-200 sm:py-20 py-12'>
            <div className='container mx-auto grid sm:grid-cols-2 gap-2 items-center'>
                <div className='px-8 text-gray-900 whitespace-pre-wrap break-normal text-justify'>
                    {packageData.moredesc}
                </div>
                <div className='px-16 grid sm:grid-cols-2 gap-8'>
