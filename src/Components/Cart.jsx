                                        ...
                                        <li key={index} className="flex py-6">
                                            ...
                                            <div className="ml-2 flex flex-1 flex-col">
                                                <div>
                                                    ...
                                                    <Link target="_blank" onClick={()=>setOpen(false)} to={product?.type==="single" ? `/products/${((product?.product?.name?.replace(/\s+/g, '-')).replace(/[^a-zA-Z0-9--]/g, '').toLowerCase())}/${product.product._id}` : `/packages/${((product?.product?.name?.replace(/\s+/g, '-')).replace(/[^a-zA-Z0-9--]/g, '').toLowerCase())}/${product.product._id}`} className='font-semibold hover:underline'>
