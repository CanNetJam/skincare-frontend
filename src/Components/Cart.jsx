                        ...
                        <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                            ...
                                            <div className="flex flex-1 items-end justify-between text-sm py-2">
                                                ...
                                                <div className="relative flex gap-2 items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        }} type="button" id="decrement-button" data-input-counter-decrement="counter-input" className={`${product.quantity>1 ? 'hover:bg-gray-200 dark:hover:bg-gray-600' : null}flex-shrink-0 bg-gray-100 dark:bg-gray-700  dark:border-gray-600 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none`}>
                                                        ...
                                                        <input readOnly value={product.quantity} type="text" id={`counter-input`+product.product._id} data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" />
                                                        <button onClick={()=>handleAddQuantity(product)} disabled={product.product?.stock>product.quantity ? false : true} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                            ...
                            <div className="mt-6 w-full flex justify-center">
                                <button onClick={()=> {
                                    ...
                                    userData.token!==undefined && cartData.length>0 ? false : true
                                } className={`${userData.token!==undefined && cartData.length>0 ? 'bg-blue-500 hover:bg-blue-700' : 'bg-gray-500'} relative flex items-center justify-center rounded-md border border-transparent px-6 py-3 text-base font-medium text-white shadow-sm`}>
