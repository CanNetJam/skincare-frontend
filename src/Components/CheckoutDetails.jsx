...
export default function CheckoutDetails({cartData, cartTotal, shippingFee, subTotal, exceed, currentVoucher, setCurrentVoucher}) {
    ...
    return (
        <>
            <div className="grid sm:mt-16 mt-0">
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="grid justify-center border-t-2 border-gray-200">
                            ...
                            <div className="flex justify-center">
                                <button disabled={delivery==="" || payment==="" || exceed===true || loading!==false ? true : false} type='submit' className={`${delivery==="" || payment==="" || loading===true ? 'bg-gray-500': ' before:bg-yellow-200 before:-z-10 bg-blue-400 z-0 text-slate-50 transition-colors before:absolute before:left-0 before:top-0 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:duration-300 hover:text-black before:hover:scale-x-100 overflow-hidden'} relative flex gap-2 text-center py-2 w-auto sm:px-10 px-6 font-bold rounded-md`}>
                                    {loading===true ? 
                                        <div role="status">
