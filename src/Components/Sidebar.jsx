...
import Logo from '../assets/Klued-logo.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`sticky top-0 left-0 z-9999 flex h-screen w-[300px] flex-col overflow-y-hidden bg-gray-700 text-white duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
