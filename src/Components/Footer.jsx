...
export default function Footer() {
    ...
    return (
        <div className="bg-slate-900 sm:h-auto h-auto w-full sm:px-10 p-4">
            ...
            <div className='grid justify-center gap-2 sm:flex sm:flex-row-reverse sm:justify-between px-6 py-2 items-center'>
                <div className='flex justify-center items-center text-slate-400 gap-8'>
                    <a href='https://www.facebook.com/Klued' target='_blank' className='cursor-pointer hover:text-slate-300'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill='#cbd5e1' width="28" height="28" viewBox="0 0 24 24"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 10h-2v2h2v6h3v-6h1.82l.18-2h-2v-.833c0-.478.096-.667.558-.667h1.442v-2.5h-2.404c-1.798 0-2.596.792-2.596 2.308v1.692z"/></svg>
                    </a>
