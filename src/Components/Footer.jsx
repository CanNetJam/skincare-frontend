        ...
        <form className="w-full">
          ...
          <div className="p-2 focus-within:ring sm:flex sm:items-center sm:gap-4 border border-gray-300 rounded-md">
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-100">Products</p>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <a href="#" className="text-gray-300 transition hover:opacity-75">
                  Klued - 0.1% Retinol + 0.3% Bakuchiol Serum
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-slate-800">C</p>

              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="#" className="text-gray-300 transition hover:opacity-75">
                  Klued - 0.5% Retinol Serum
                  </a>
                </li>

                <li>
                  <a href="#" className="text-gray-300 transition hover:opacity-75">
                  Klued - 2% BHA Exfoliating Toner
                  </a>
                </li>

                <li>
                  <a href="#" className="text-gray-300 transition hover:opacity-75">
                  Klued - Vit C 15% Serum
                  </a>
                </li>

                <li>
                  <a href="#" className="text-gray-300 transition hover:opacity-75">
                  Klued - Multi-Hyaluronic Acid Complex Serum
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-100">Shop</p>

              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="https://www.tiktok.com/@klued_" target="_blank" className="text-gray-300 transition hover:opacity-75">
                    Tiktok
                  </a>
                </li>

                <li>
                  <a href="https://www.lazada.com.ph/tag/klued/" target="_blank" className="text-gray-300 transition hover:opacity-75">
                    Lazada
                  </a>
                </li>

                <li>
                  <a href="https://shopee.ph/klued" target="_blank" className="text-gray-300 transition hover:opacity-75">
                    Shopee
                  </a>
                </li>
              </ul>
            ...
            <div className="col-span-2 sm:col-span-1">
              <p className="font-medium text-gray-100">Talk to us</p>

              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <p  className="text-gray-300 transition hover:opacity-75">
                    mapa@kluedskincare.com
                  </p>
                </li>
