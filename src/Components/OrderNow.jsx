    ...
    return (
        <>
            <div className="sm:min-h-[50vh] h-auto w-full bg-blue-300 grid justify-center py-6">
                ...
                <br/>
                <div className="h-full grid grid-cols-3 sm:flex">
                    ...
                    <a href={productlinks?.lazada}
                        target="_blank" className="sm:h-[175px] sm:w-[200px] h-[100px] w-[120px] overflow-hidden rounded-xl p-4 cursor-pointer">
