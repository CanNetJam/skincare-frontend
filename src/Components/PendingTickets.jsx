                                        ...
                                        <tr key={a._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className=''>
                                                    ...
                                                    :null}
                                                    {a.status==="Investigating" && userData.user?._id===a.orderid.userid ?
                                                        <label className='italic py-2 text-center'>Note: Please wait for Klued to process your ticket. We could send an email to your registered email address if necessary.</label>
                                                    :null}
                                                </div>
                                            </td>
