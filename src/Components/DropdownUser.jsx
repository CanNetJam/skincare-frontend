        ...
        <div className="relative">
            ...
            >
                {userData.user?.displayimage ? 
                    <span className="h-8 w-8 cursor-pointer overflow-hidden rounded-full">
                        <img height={'50px'} width={'50px'} title='Profile picture' alt={`Profile picture`} loading='eager' className='w-full h-full rounded-full mb-4 shrink-0 object-cover' src={`https://klued-uploads.s3.ap-southeast-1.amazonaws.com/${forwardUserData?.displayimage ? forwardUserData?.displayimage : userData.user.displayimage}`}></img>
                    </span>
                :
                <>
                    {forwardUserData?.displayimage ? 
                    <span className="h-8 w-8 cursor-pointer overflow-hidden rounded-full">
                        <img height={'50px'} width={'50px'} title='Profile picture' alt={`Profile picture`} loading='eager' className='w-full h-full rounded-full mb-4 shrink-0 object-cover' src={`https://klued-uploads.s3.ap-southeast-1.amazonaws.com/${forwardUserData?.displayimage}`}></img>
                    </span>
                    :
            ...
            <div
                ...
                className={`rounded-lg absolute right-0 mt-3 py-4 flex w-[230px] flex-col border border-stroke bg-white shadow-gray-700 shadow-md dark:border-strokedark dark:bg-boxdark ${
            ...
            >
                ...
                {userData.user?.type==="Super Admin" ?
                    <li>
                        <Link onClick={()=>setDropdownOpen(false)} to="/sales-report" className="relative hover:bg-gray-100 cursor-pointer px-6 py-2 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                ...
                {userData.user?.type==="Super Admin" || userData.user?.type==="Store Admin" ? 
                    <li>
                            <div onClick={()=>{
                                ...
                                setTransactions(false)
                                setUsers(false)
                            }} className="relative hover:bg-gray-100 cursor-pointer px-6 py-2 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                ...
                {userData.user?.type==="Customer" ?
                    <>
                        <li>
                            <Link onClick={()=>setDropdownOpen(false)} to={`/orders/${userData.user._id}`} state={{profileid: userData.user._id}} className="px-6 py-2 hover:bg-gray-100 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                        ...
                        <li>
                            <Link onClick={()=>setDropdownOpen(false)} to={`/tickets/${userData.user._id}`} state={{profileid: userData.user._id}} className="px-6 py-2 hover:bg-gray-100 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 22v-20h16v11.543c0 4.107-6 2.457-6 2.457s1.518 6-2.638 6h-7.362zm18-7.614v-14.386h-20v24h10.189c3.163 0 9.811-7.223 9.811-9.614zm-11.073-8.14c-.081-.659.431-1.246 1.101-1.246.628 0 1.124.552 1.045 1.184l-.618 4.941c-.029.231-.226.405-.459.405-.232 0-.43-.174-.459-.405l-.61-4.879zm1.069 8.754c-.563 0-1.021-.457-1.021-1.021s.457-1.021 1.021-1.021c.564 0 1.021.457 1.021 1.021s-.457 1.021-1.021 1.021z"/></svg>
                                My Tickets
                            </Link>
                        </li>
                ...
                :null}
                    ...
                    <li>
                        ...
                        className="mb-4 flex items-center px-6 py-2 hover:bg-gray-100 gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                        >
                        <svg
                ...
                <button onClick={()=>{ logOut(), navigate("/")}} className="flex items-center hover:bg-gray-100 gap-3.5 mt-4 py-2 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
