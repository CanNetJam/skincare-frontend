            ...
            >
                ...
                {userData.user.type==="Super Admin" || userData.user.type==="Admin" ? 
                    <>
                        ...
                        <li>
                            <Link
                            to="/emails"
                            className="flex items-center gap-3.5 text-xs font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                            >
                ...
                :null}
                    ...
                    <li>
                        ...
                        className="mb-4 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                        >
                        <svg
                ...
                <button onClick={()=>{ logOut(), navigate("/")}} className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
                    <svg
                        className="fill-current"
                        width="22"
                        height="22"
