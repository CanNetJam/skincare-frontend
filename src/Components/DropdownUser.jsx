  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-2 py-4 flex w-[220px] flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
