...
export default function FooterCallToAction() {
    return (
        <div style={{'--image-url': `url(${img1})`}} className='bg-[image:var(--image-url)] bg-no-repeat bg-cover h-[50vh] w-full mt-10'>
            <div className='h-full w-full container mx-auto relative sm:max-w-xl md:max-w-3xl lg:max-w-6xl'>
                <div className='absolute top-1/2 -translate-y-1/2 sm:left-0 sm:-translate-x-0 left-1/2 -translate-x-1/2 h-auto sm:max-w-md w-full sm:px-0 px-4'>
